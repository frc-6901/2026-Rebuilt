...
public final class Constants {
        ...
        public static final class RetakeConstants {
                public final static Time OuttakeDuration = Seconds.of(0.4);
                public final static Time IntakeDuration = Seconds.of(0.4);

                public final static Time TotalDuration = OuttakeDuration.plus(IntakeDuration);

                public final static AngularVelocity OuttakeRPS = RotationsPerSecond.of(20);
                public final static AngularVelocity IntakeRPS = RotationsPerSecond.of(60);
        }
