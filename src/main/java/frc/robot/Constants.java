...
public final class Constants {
        ...
        public static final class RetakeConstants {
                public final static Time OuttakeDuration = Seconds.of(0.5);
                public final static Time IntakeDuration = Seconds.of(1.2);

                public final static Time TotalDuration = OuttakeDuration.plus(IntakeDuration);

                public final static AngularVelocity OuttakeRPS = RotationsPerSecond.of(30.6901);
                public final static AngularVelocity IntakeRPS = RotationsPerSecond.of(80);
        }
